...
namespace WinFormsHtmlNotification
{
    ...
    public class FloatingWindow : NativeWindow, IDisposable
    {
        ...
        #region == Painting ==
        /// <summary>
        /// Performs the painting of the window. Override this method to provide custom painting
        /// </summary>
        ...
        protected virtual void PerformPaint(PaintEventArgs e)
        {
            using (LinearGradientBrush b = new LinearGradientBrush(this.Bound, Color.LightBlue, Color.DarkGoldenrod, 45f))
            {
                ...
                e.Graphics.DrawString("Override this PerformPaint method...", new Font(FontFamily.GenericSansSerif, 12f, FontStyle.Regular), new SolidBrush(Color.FromArgb(170, Color.Red)), new PointF(0f, 10f));
            }
        }
        #endregion
